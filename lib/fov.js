...
wglt.TileMap.prototype.isVisible = function (x, y) {
...
wglt.TileMap.prototype.computeFov = function (originX, originY, radius) {
 ...
 */
wglt.TileMap.prototype.computeOctantY = function (deltaX, deltaY) {
    const startSlopes = [];
    const endSlopes = [];
    let iteration = 1;
 ...
 */
wglt.TileMap.prototype.computeOctantX = function (deltaX, deltaY) {
    const startSlopes = [];
    const endSlopes = [];
    let iteration = 1;
    let totalObstacles = 0;
